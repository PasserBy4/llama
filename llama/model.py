...
default_quantize: ContextVar[int] = ContextVar("default_quantize", default=0)
default_parallelism: ContextVar[int] = ContextVar("default_parallelism", default=0)
...
def get_linear_class():
    if default_quantize.get() == 1:
